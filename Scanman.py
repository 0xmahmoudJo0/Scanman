...
print ("       ")
print(f'{Fore.RED}##################   PLEASE WAIT UNTIL SCAN FINISH  ##################{Style.RESET_ALL}')
print ("       ")
...
subprocess.run('nmap -O -T4 --open -iL HOSTip.txt | grep -Ev "shown|Warning|detection|hops|done|Starting|Host|closed|Runing|CPE" | cut -c 1-50 >> RESULTS.txt ' , shell=True)    
