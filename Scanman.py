...
subprocess.run('echo Identified protocol for each HOST    >>RESULTS.txt' , shell=True)
subprocess.run('echo ------------------------------------- >> RESULTS.txt ' , shell=True)
...
subprocess.run('echo ---------------------------------- >> RESULTS.txt ' , shell=True)
subprocess.run('echo OS and Open Ports for each HOST   >> RESULTS.txt' , shell=True)
subprocess.run('echo ---------------------------------- >> RESULTS.txt ' , shell=True)
